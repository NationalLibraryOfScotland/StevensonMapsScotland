...
// the Stevenson GeoJSON file for all the maps
	...
	var stevenson_geojson = 'https://geo.nls.uk/maps/stevenson/scripts/stevenson_areas_09_august.js';
...
//	alert ("selectedFeatureszoomtoID.length: " + selectedFeatureszoomtoID.length);
...
// set header depending on selectedFeatures.length
					...
					var resultsheader = "";
	           	 		...
	           	 		resultsheader += '<div id="deselect"><a href="javascript:deselect();">Deselect this plan</a></div><br/><p><strong>Results - 1 plan:</strong><br /></p>';
...
// listener on map.getLayers().getArray()[1] - when features are loaded from GeoJSON initiate filter()
	    ...
	    var stevenson_geojson_layer_ready;
		  ...
		  if (map.getLayers().getArray()[1].getSource().getFeatures().length > 2000) {
